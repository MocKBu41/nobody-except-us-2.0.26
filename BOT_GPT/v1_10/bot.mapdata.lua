-- NEU BOT v1.10 map knowledge
-- Robust matching by unique runtime flag names, fuzzy fallback, duplicate-coordinate support.
...
function M:distanceFromSpawn(name)
    if not self.spawn then return nil end
    local best=nil
