...
function G.appendIndex(N)
    ...
    local line = '{"type":"geometry_index","version":"2.0.4","team":'..q(BotApi.Instance.team)..',"runtimeFlags":'..stringListJson(G.runtimeFlags)..',"candidates":['..table.concat(candidates,',')..']}'
